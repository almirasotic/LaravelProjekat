...
<head>
    ...
    <style>
        ...
        .tables-container {
            display: flex;
            gap: 20px; /* Razmak između tabela */
            justify-content: space-around;
            align-items: flex-start;
        }

        .manage_container {
            flex: 1; /* Tabele će zauzimati jednaku širinu */
            min-width: 45%; /* Minimalna širina svake tabele */
        }
        ...
        .reject-button {
            background-color: #f44336; /* Crveno */
            color: white;
        }
    </style>
</head>
    ...
    <x-layout>
        ...
        <div class="tables-container">
            @unless ($themes->isEmpty())
                <div class="manage_container" style="color: white;">
            ...
            @else
                <div class="manage_container">
                    <h1 class="heading">Nema korisnika</h1>
                </div>
            @endunless
        </div>
