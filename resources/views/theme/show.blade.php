    ...
    <a href="{{ url()->previous() }}" class="back">Home</a>
        ...
        <div class="theme_Container">
            ...
            <div class="theme_Info">
                ...
                <div class="follow">
                        <a href="/themes/addComment?themeTitle={{ $theme->title }}&themeId={{ $theme->id }}" class="theme_button_comment" style="margin-right: 250px;">
                          Odgovori na temu
                        </a>
                ...
                <div class="comment_card" style="position: relative;">
                        ...
                        @if ($comment->user)
                            <span class="user">
                                @if ($comment->user->picture != "null")
                                    <img src="{{ asset('storage/' . $comment->user->picture) }}" alt="{{ $comment->user->name }}" style="width:100px; height:100px; border-radius:10px; margin-right:-10px">
                                @else
                    ...
                    <div class="comment_right" style="position: relative;">
                        <p style=" padding-bottom:15px">
                            <span style="color: black; font-size:18px; font-weight: bold;"> {{ $theme->title }}</span>
                        </p>
