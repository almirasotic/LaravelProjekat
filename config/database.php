    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', 'dpg-cpqoo0lds78s73cmqmog-a'),
            'port' => env('DB_PORT', '5432'),
            'database' => env('DB_DATABASE', 'laravel_memcache_db_qfzs'),
            'username' => env('DB_USERNAME', 'laravel_memcache_db'),
            'password' => env('DB_PASSWORD', 'BD4vZDFovxBP2W61A8ewl1mhtmlanezQ'),
